function plot_throughput_nn(symmetry, policy, lutf)
...
for k1 = 1:length(symmetry)
    ...
    for k2 = 1:length(policy)
        f = sprintf('../throughput_nn_%s_%s.dat', symmetry{k1}, policy{k2});
    ...
    print('-depsc2', sprintf('throughput_nn_%s.eps', symmetry{k1}));
end
